const reviews = [
    {
      id:0,
      name:"Harshil Gandhi",
      job:"Student ,V.I.T Vellore",
      image:"https://i.ibb.co/nsF4MBv/profile.jpg",
      text:"I am Complex problem-solver with analytical and driven mindset.Dedicated to achieving demanding development objectives according to tight schedules while producing impeccable code!",
    },
    {
      id: 1,
      name: "Pranay Gupta",
